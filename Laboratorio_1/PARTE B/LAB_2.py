...
class LAB_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "PARTE A", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PARTE A")
        ...
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "Frecunecia Potadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._A_win = RangeWidget(self._A_range, self.set_A, "Amplitd señal TX", "counter_slider", float, QtCore.Qt.Horizontal)
