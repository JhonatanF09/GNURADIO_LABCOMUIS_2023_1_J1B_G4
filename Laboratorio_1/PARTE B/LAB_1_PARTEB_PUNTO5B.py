...
class LAB_1_PARTEB_PUNTO5B(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FILTRADO", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB_1_PARTEB_PUNTO5B")
...
def main(top_block_cls=LAB_1_PARTEB_PUNTO5B, options=None):
