...
class Lab_comu_I_J1E_G4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_comu_I_J1E_G4")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, frecuency, amplitud, 0, 0)
...
def main(top_block_cls=Lab_comu_I_J1E_G4, options=None):
