...
class ConfiguracionUSRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Signal = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 5000, A, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.Signal, 0), (self.CalculoPotenciaJ1B_0, 0))
        self.connect((self.Signal, 0), (self.blocks_float_to_complex_0, 0))
    ...
    def set_A(self, A):
        self.A = A
        self.Signal.set_amplitude(self.A)
