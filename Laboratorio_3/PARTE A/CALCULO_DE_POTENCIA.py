...
class CALCULO_DE_POTENCIA(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Potencia_Seno", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Potencia_Seno")
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.CalculoPotenciaJ1B_0, 0))
